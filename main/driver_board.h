 ...
 *   4 = abduction<->knee swap  (abduction port broken/unused, calf servo
 *                plugged into abduction port instead. Swaps abduction and knee
 *                within each leg: 1<->3, 4<->6, 7<->9, 10<->12;
 *                hips 2,5,8,11 unchanged.)
 *
...
static inline int db_phys(int logical){
    ...
    switch(logical){
        //Change abduction and knee servo channels / Change left -> right , right -> left
        case 1:  return 6;   case 6:  return 1;
        case 4:  return 3;   case 3:  return 4;
        case 7:  return 12;   case 12:  return 7;
        case 10: return 9;  case 9: return 10;
        //Change thigh from left -> right , right -> left
